            ...
            <div className='flex flex-wrap-reverse justify-between items-center gap-2 sm:gap-6'>
                <div className="card">
                    ...
                    <p className='text-base md:text-base lg:text-lg leading-relaxed text-gray-400'>
                        If you have a project that you want to get started on, if you think you need my assistance with something, or just some advice, then get in touch.
                    </p>
                    <form className='flex flex-col gap-5 mt-5 sm:mt-10' onSubmit={handleSubmit}>
                        ...
                        <div className='relative peer'>
                            <input type="text" placeholder='Tell me about your project' className='contactInput peer' required />
                            <span className='line'></span>
                        </div>
                        <button
                            type='submit'
