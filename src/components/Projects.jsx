                ...
                <Swiper
                    ...
                    <SwiperSlide className='flex justify-center'>
                        <div className='project-card'>
                            ...
                            transform translate-x-1/2 bg-tPrimary text-primary rounded-t-lg px-2 py-1 text-xs font-semibold'>Web App</span>
                                </div>
                                <div className='mt-4'>
                            ...
                            <div className='flex justify-between items-center'>
                                ...
                                <a href="https://tikitaka-iota.vercel.app/" target='_blank' className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">View Project</a>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='flex justify-center'>
                        <div className='project-card'>
                            ...
                            <div className='flex justify-between items-center'>
                                ...
                                <a href="https://ilyasdevsample.github.io/travel_companion/" target='_blank' className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">View Project</a>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='flex justify-center'>
                        <div className='project-card'>
                            <div>
                                <div className='relative '>
                                    <a href=""><img src="images/travelCompanionImage.png" className='w-full h-[150px] rounded-t-lg
                            object-cover object-center
                            ' alt="Project Image" />
                                    </a>
                                    <span className='absolute bottom-0 right-1/2 
                            transform translate-x-1/2 bg-tPrimary text-primary rounded-t-lg px-2 py-1 text-xs font-semibold'>Web App</span>
                                ...
                                <div className='mt-4'>
                                    <h3 className='text-2xl font-extrabold mb-2 capitalize'>Travel Companion3</h3>
                                    <p className='text-sm mb-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quod. Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    </p>
                            ...
                            <div className='flex justify-between items-center'>
                                ...
                                <a href="" className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">View Project</a>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='flex justify-center'>
                        <div className='project-card'>
                            ...
                            transform translate-x-1/2 bg-tPrimary text-primary rounded-t-lg px-2 py-1 text-xs font-semibold'>Web App</span>
                                ...
                                <div className='mt-4'>
                                    <h3 className='text-2xl font-extrabold mb-2 capitalize'>Travel Companion4</h3>
                                    <p className='text-sm mb-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quod. Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    </p>
